...
export default function DataPanel({ 
  ...
  return (
    <div 
      className={`relative transition-all duration-300 ease-in-out border-l border-gray-200 bg-gray-50 flex flex-col h-full shadow-inner ${
        isExpanded ? 'w-[360px]' : 'w-12'
      }`}
    >
      ...
      <div className={`flex flex-col h-full p-4 transition-opacity duration-200 ${

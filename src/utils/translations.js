export const translations = {
    en: {
        ...
        tutorial: {
            ...
            t1Name: "1. Basic Editing & Inspector",
            t1Desc: "Learn how to select passages and modify titles and descriptions.",
            t1Step1Title: "Select a Scene",
            t1Step1Desc: "Double-click or single-click the 'Start' node in the canvas to open the Inspector panel on the right.",
            t1Step2Title: "Modify Node Title",
            t1Step2Desc: "In the Inspector panel, locate the 'Etiqueta' (Label) input field. Delete the text and type 'Entrada' as the new title of this node.",
            t1Step3Title: "Edit Story Text",
            t1Step3Desc: "Great! Now edit the main text content inside the narrative editor text area. Type: 'Estás no início da aventura.' to set the passage text.",
            t1Step4Title: "Scene Updated!",
            t1Step4Desc: "Fantastic! You successfully updated your first story node title and description. Click Finish to complete this module.",
            t2Name: "2. Visual Connections & Validator",
            t2Desc: "Learn to connect scenes and find logical issues.",
            t2Step1Title: "Drag Connection",
            t2Step1Desc: "Connect two scenes visually. Click and drag a line from the circular handle at the bottom of the 'Start' node to the top handle of the 'Corredor' node, then click Confirm in the modal.",
            t2Step2Title: "Add a New Passage",
            t2Step2Desc: "Let's expand the story map! Click the '+ Adicionar Cena' (+ Add Scene) button in the TopBar to spawn a new scene node on the board.",
            t2Step3Title: "Connect the New Scene",
            t2Step3Desc: "Excellent. Now click and drag from the circular handle at the bottom of the 'Corredor' node to the top of your newly added scene, and click Confirm in the modal.",
            t2Step4Title: "Check Logical Consistency",
            t2Step4Desc: "Now let's check for unreachable nodes or loops. Click the 'Validar Lógica' (Validate Logic) button on the left panel (Data Engine).",
            t2Step5Title: "Graph Consistent!",
            t2Step5Desc: "Great job! The validator confirmed your story is logically consistent and all passages are reachable. Click Finish to complete.",
            ...
            t5Desc: "Learn to visually drag conditional choices based on player inventory variables.",
            t5Step1Title: "Select Castle Gate Node",
            t5Step1Desc: "Select the 'Portão' node by single-clicking or double-clicking it on the graph.",
            t5Step2Title: "Create Conditional Choice",
            t5Step2Desc: "Click and drag from the circular handle at the bottom of the 'Portão' node to the top of the 'Sucesso' node. In the connection modal, select 'Condicional ⚡', select variable 'temChave', operator 'is', value 'true', type 'Abrir Portão' as choice text, and click 'Confirmar Ligação'.",
            t5Step3Title: "Play Mode Testing",
            t5Step3Desc: "Great job! The SugarCube conditional code was visually generated. Now let's test it! Click 'Play' in the top bar to enter play mode, advance to 'Portão', and see the gate unlock since you found the key."
        }
    },
    ...
    pt: {
        ...
        tutorial: {
            ...
            t1Name: "1. Edição Básica & Inspector",
            t1Desc: "Aprende a selecionar passagens e a modificar títulos e descrições.",
            t1Step1Title: "Selecionar uma Cena",
            t1Step1Desc: "Dá duplo clique ou clica no nó 'Start' no ecrã para abrir o painel do Inspector à direita.",
            t1Step2Title: "Modificar Título do Nó",
            t1Step2Desc: "No painel do Inspector, localiza o campo de entrada 'Etiqueta' (Label). Apaga o texto atual e escreve 'Entrada' como o novo título deste nó.",
            t1Step3Title: "Editar Texto da História",
            t1Step3Desc: "Ótimo! Agora edita o conteúdo do texto principal no painel do Inspector. Escreve: 'Estás no início da aventura.' para definir o texto da passagem.",
            t1Step4Title: "Cena Atualizada!",
            t1Step4Desc: "Fantástico! Atualizaste o título e a descrição do teu primeiro nó da história. Clica em Terminar para concluir este módulo.",
            t2Name: "2. Ligações Visuais & Validador",
            t2Desc: "Aprende a ligar cenas e a encontrar problemas lógicos no grafo.",
            t2Step1Title: "Arrastar Ligação",
            t2Step1Desc: "Liga as duas cenas visualmente. Clica e arrasta uma linha a partir da pega circular no fundo do nó 'Start' até à pega no topo do nó 'Corredor', e confirma no modal.",
            t2Step2Title: "Adicionar Nova Passagem",
            t2Step2Desc: "Vamos expandir o mapa da história! Clica no botão '+ Adicionar Cena' na barra superior para criar um novo nó no tabuleiro.",
            t2Step3Title: "Ligar a Nova Cena",
            t2Step3Desc: "Excelente. Agora clica e arrasta a partir da pega circular no fundo do nó 'Corredor' até ao topo do teu novo nó de cena, e confirma no modal.",
            t2Step4Title: "Verificar Consistência Lógica",
            t2Step4Desc: "Agora vamos testar o grafo para ver se há nós inacessíveis. Clica no botão 'Validar Lógica' no painel esquerdo (Motor de Dados).",
            t2Step5Title: "Grafo Consistente!",
            t2Step5Desc: "Excelente trabalho! O validador graduou a tua história como logicamente consistente e todas as passagens são acessíveis. Clica em Terminar.",
            ...
            t5Desc: "Aprende a criar ligações condicionais visualmente com base em variáveis.",
            t5Step1Title: "Selecionar o Nó do Portão",
            t5Step1Desc: "Seleciona o nó 'Portão' clicando nele ou dando duplo clique no grafo.",
            t5Step2Title: "Criar Escolha Condicional",
            t5Step2Desc: "Clica e arrasta a partir da pega circular no fundo do nó 'Portão' até ao topo do nó 'Sucesso'. No modal de ligação, escolhe 'Condicional ⚡', escolhe a variável 'temChave', operador 'is', valor 'true', escreve 'Abrir Portão' no texto da escolha, e clica em 'Confirmar Ligação'.",
            t5Step3Title: "Testar no Modo Jogo",
            t5Step3Desc: "Excelente! O código condicional SugarCube foi gerado automaticamente. Agora vamos testar! Clica em 'Jogar' na barra superior, avança até ao portão, e vê o portão abrir porque encontraste a chave."
        }
    }
};

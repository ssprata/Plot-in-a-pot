...
Em suma, o \textit{Plot in a Pot} cumpriu os seus objetivos ao aproximar a engenharia de software e a teoria de grafos do \textit{game design} e da escrita criativa. Ao aliar validação formal, interação visual e acessibilidade, a plataforma assume-se como uma ferramenta robusta para a criação de narrativas não-lineares e um ponto de partida sólido para futuras investigações.

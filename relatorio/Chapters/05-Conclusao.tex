...
Em suma, o desenvolvimento do \textit{Plot in a Pot} alcançou com sucesso os objetivos propostos, proporcionando uma solução integrada, acessível e computacionalmente sólida para a modelação e validação de narrativas interativas. Espera-se que este trabalho não só facilite a tarefa da escrita de narrativas não-lineares para autores e criadores, mas também sirva como base para o desenvolvimento futuro de novas ferramentas e técnicas no domínio dos jogos interativos.

...
Em suma, o \textit{Plot in a Pot} cumpre o propósito de aproximar a engenharia de software e a teoria de grafos da escrita criativa e do \textit{game design}. Ao unificar a robustez da validação de espaço de estados com a flexibilidade da interação visual e acessibilidade inclusiva, a plataforma capacita autores na materialização de narrativas interativas complexas, abrindo portas a novas metodologias de desenvolvimento na indústria de jogos não-lineares.

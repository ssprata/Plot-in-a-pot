...
\begin{enumerate}
    ...
    Para garantir a eficiência temporal do validador, o motor começa por indexar e organizar os elementos do canvas em duas estruturas de dados fundamentais em memória:
    \begin{itemize}

...
O módulo responsável pela serialização e desserialização de histórias na plataforma é o parser síncrono, implementado em \texttt{tweeParser.js} (na diretoria \texttt{src/utils/}). Este módulo assegura a tradução bidirecional em tempo real entre a representação visual baseada em grafos do React Flow e a representação textual baseada na especificação \textbf{Twee 3} \citep{Twee3Reference}.

...
Dada a vizinhança do nó atual, correspondente ao conjunto de opções de escolha alcançáveis a partir dele, o agente consulta o histórico de visitas acumuladas do simulador. Para cada opção de transição que leva a um nó vizinho, o Smart Walker obtém o número acumulado de visitas históricas registado na memória global da sessão. O Smart Walker escolhe automaticamente a transição para o nó vizinho que foi visitado menos vezes até ao momento.

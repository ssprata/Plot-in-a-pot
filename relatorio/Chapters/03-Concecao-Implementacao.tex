...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \end{center}
        O parser analisa o bloco interno à procura de comandos como \lstinline|<<goto "Destino">>| ou atribuições como \lstinline|<<set $proximo_destino = "Destino">>| para gerar as arestas direcionadas.
    \end{itemize}

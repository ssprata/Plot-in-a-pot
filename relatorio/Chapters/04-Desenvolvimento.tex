...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node [block, right=of wave1] (fix1) {\textbf{Ajustes 1}\\Zonas e\\Arestas Curvas};
        \node [block, right=of fix1] (wave2) {\textbf{Leva 2 (Maio)}\\Protótipo Intermédio\\(SugarCube e CSV)\\SUS: \textbf{73.0}};
        \node [block, right=of wave2] (fix2) {\textbf{Ajustes 2}\\VariablesModal e\\Parser CSV RFC-4180};
        \node [block, right=of fix2] (wave3) {\textbf{Leva 3 (Junho)}\\Protótipo Final\\(PlayMode, BFS, Walker)\\SUS: \textbf{84.6}};

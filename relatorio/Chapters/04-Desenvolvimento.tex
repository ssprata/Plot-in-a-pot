...
Os testes foram realizados com um grupo de seis utilizadores (U1 a U6) composto por estudantes de licenciatura e mestrado do Politécnico de Leiria. O grupo apresenta uma distribuição equilibrada de géneros (três masculinos e três femininos) e faixas etárias típicas da população académica (entre os 21 e os 25 anos), caracterizando-se por perfis e graus de especialização técnica distintos:
\begin{itemize}
    \item \textbf{U1:} Feminino, 23 anos. Estudante do \textbf{Mestrado em Desenvolvimento de Jogos Digitais} (ESTG/ESAD.CR), ramo de \textit{Game Arts}. Possui experiência em escrita de ficção interativa com Twine, mas sem qualquer base ou conhecimentos em programação.
    \item \textbf{U2:} Masculino, 22 anos. Estudante da \textbf{Licenciatura em Engenharia Informática} (ESTG). Experiência avançada em desenvolvimento \textit{web} síncrono e arquitetura de sistemas.
    \item \textbf{U3:} Masculino, 25 anos. Estudante do \textbf{Mestrado em Desenvolvimento de Jogos Digitais} (ESTG), ramo de \textit{Game Programming}. Interesse focado em lógica de grafos e motores de jogo.
    \item \textbf{U4:} Feminino, 21 anos. Estudante da \textbf{Licenciatura em Comunicação e Média} (ESECS). Sem experiência anterior em escrita interativa ou lógica condicional.
    \item \textbf{U5:} Feminino, 22 anos. Estudante da \textbf{Licenciatura em Design Gráfico} (ESAD.CR), com especial interesse em ergonomia visual e usabilidade de interfaces.
    \item \textbf{U6:} Masculino, 24 anos. Estudante da \textbf{Licenciatura em Engenharia Informática} (ESTG), portador de daltonismo severo (deuteranopia) e baixa acuidade visual.
\end{itemize}

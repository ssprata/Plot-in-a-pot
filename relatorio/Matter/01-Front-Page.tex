...
\begin{titlepage}
    ...
    \ifdefined\GetSecondAuthor
        ...
        \ifdefined\GetSecondAuthorNumber
            {\noindent\itshape\fontsize{10}{10}\selectfont Student No. \GetSecondAuthorNumber}
        \fi
	\fi
    ...
    \ifdefined\GetThirdAuthor
        ...
        \ifdefined\GetThirdAuthorNumber
            {\noindent\itshape\fontsize{10}{10}\selectfont Student No. \GetThirdAuthorNumber}
        \fi
	\fi
    ...
    \hspace*{-2.5pt}\begin{tabular}{@{}r@{\hspace{5pt}}>{\raggedright\arraybackslash}m{6cm}@{}}
        \textbf{Supervisores:} & \GetSupervisor \\ [-.7ex]
